...
const App = () => {
  ...
  const contractAddress = "0xAa9F9afe02963cb4Af63bFC13cF5B9ba7A4E8211";
  ...
  const getAllWaves = async () => {
    try {
      ...
      if (ethereum) {
        ...
        //retrieving getAllWaves from Smart Contract
        const waves = await wavePortalContract.getAllWaves();

        //filter out required for the UI; address, timestamp and message
        let wavesCleaned = [];
        waves.forEach(wave => {
          wavesCleaned.push({
            address: wave.waver,
